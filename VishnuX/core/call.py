...
from VishnuX import LOGGER, YouTube, app
...
from VishnuX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from VishnuX.utils.stream.autoclear import auto_clean
from VishnuX.utils.thumbnails import gen_thumb
...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1001873246625)
        await assistant.join_group_call(
            -1001873246625,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1001873246625)
