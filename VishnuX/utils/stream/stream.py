...
import config
from VishnuX import Carbon, YouTube, app
from VishnuX.core.call import Vishnu
from VishnuX.misc import db
from VishnuX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from VishnuX.utils.exceptions import AssistantErr
from VishnuX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from VishnuX.utils.inline.playlist import close_markup
from VishnuX.utils.pastebin import Vishnubin
from VishnuX.utils.stream.queue import put_queue, put_queue_index
from VishnuX.utils.thumbnails import gen_thumb, gen_thumbb
...
async def stream(
    ...
    if forceplay:
        await Vishnu.force_stop_stream(chat_id)
