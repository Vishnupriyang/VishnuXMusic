...
from VishnuX.utils import help_pannel
from VishnuX.utils.database import get_lang, is_commanddelete_on
from VishnuX.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from VishnuX.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkBAAIEymM3Fhf9lybmWwXZSfmE5xAkioklAAKWBQACjtggV3QhvvbMnN0WKgQ")
