...
from VishnuX.utils import get_readable_time
from VishnuX.utils.database import (add_banned_user,
                                       get_banned_count,
                                       get_banned_users,
                                       get_served_chats,
                                       is_banned_user,
                                       remove_banned_user)
from VishnuX.utils.decorators.language import language
...
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgUAAxkBAAIE3GM3Gq4X0XEx6PB8w1Z69Uo7pS9YAAKIBQACINMgV9yd6S_JbaAIKgQ")
