...
from VishnuX.utils.database import (delete_authuser, get_authuser,
                                       get_authuser_names,
                                       save_authuser)
from VishnuX.utils.decorators import AdminActual
from VishnuX.utils.formatters import int_to_alpha
...
async def auth(client, message: Message, _):
    if not message.reply_to_message:
        ...
        if token not in _check:
            ...
            await message.reply_sticker("CAACAgUAAxkBAAIE5GM3Jm7KYJUSeFYb4QqmstBnZ61EAAKWBQACjtggV3QhvvbMnN0WKgQ")
