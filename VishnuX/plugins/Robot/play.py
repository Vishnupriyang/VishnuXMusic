...
from VishnuX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from VishnuX.core.call import Vishnu
from VishnuX.utils import seconds_to_min, time_to_seconds
from VishnuX.utils.channelplay import get_channeplayCB
from VishnuX.utils.database import is_video_allowed
from VishnuX.utils.decorators.language import languageCB
from VishnuX.utils.decorators.play import PlayWrapper
from VishnuX.utils.formatters import formats
from VishnuX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from VishnuX.utils.inline.playlist import botplaylist_markup
from VishnuX.utils.logger import play_logs
from VishnuX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("VishnuAdmin") & ~BANNED_USERS
)
async def Vishnu_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
            "ʏᴏᴜ'ʀᴇ ᴀɴ VISHNU ᴀᴅᴍɪɴ\n\nʀᴇᴠᴇʀᴛ ʙᴀᴄᴋ ᴛᴏ ᴜsᴇʀ ᴀᴄᴄᴏᴜɴᴛ ғᴏʀ ᴜsɪɴɢ ᴍᴇ.",
            show_alert=True,
        )
    except:
        return
...
@app.on_callback_query(
    filters.regex("VishnuPlaylists") & ~BANNED_USERS
)
@languageCB
